...
import {ThunderIDAuthClient, StorageManager, TokenConstants} from '@thunderid/javascript';
...
export class SPAHelper<T extends MainThreadClientConfig | WebWorkerClientConfig> {
  private _authenticationClient: ThunderIDAuthClient<T>;
  private _storageManager: StorageManager<T>;
  private _isTokenRefreshLoading = false;

  public constructor(authClient: ThunderIDAuthClient<T>) {
