...
export const WebWorkerClient = async (
  ...
  getAuthHelper: (
    authClient: ThunderIDAuthClient<WebWorkerClientConfig>,
  ...
  const _authenticationClient = new ThunderIDAuthClient<WebWorkerClientConfig>();
        ...
        if (data?.success) {
          ...
          if (data.error) {
            try {
              ...
              error = new ThunderIDAuthException(
