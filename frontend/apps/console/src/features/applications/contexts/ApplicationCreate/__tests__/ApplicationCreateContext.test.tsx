...
describe('ApplicationCreateContext', () => {
  ...
  it('has correct TypeScript interface definition', () => {
    ...
    const mockContext: ApplicationCreateContextType = {
      ...
      isEmailOtpMfaEnabled: false,
      setIsEmailOtpMfaEnabled: () => null,
      isSmsOtpMfaEnabled: false,
      setIsSmsOtpMfaEnabled: () => null,
      smsOtpSenderId: '',
      ...
      isRegistrationFlowEnabled: false,
      setIsRegistrationFlowEnabled: () => null,
      recoveryFlowId: null,
      setRecoveryFlowId: () => null,
      isRecoveryFlowEnabled: false,
      setIsRecoveryFlowEnabled: () => null,
      signOutFlowId: null,
      setSignOutFlowId: () => null,
      isSignOutFlowEnabled: false,
      setIsSignOutFlowEnabled: () => null,
      redirectUris: [],
      setRedirectUris: () => null,
      postLogoutRedirectUris: [],
      setPostLogoutRedirectUris: () => null,
      corsOrigins: [],
      setCorsOrigins: () => null,
      ouDefaults: {signIn: false, signUp: false, recovery: false, signOut: false, theme: false, layout: false},
      setOuDefaults: () => null,
