 ...
 */
export type FlowBuilderPropsInterface = DecoratedVisualFlowPropsInterface;

/**
 * Entry point for the flow builder.
 *
 * @param props - Props injected to the component.
 * @returns FlowBuilder component.
 */
function FlowBuilder({...rest}: FlowBuilderPropsInterface): ReactElement {
  return (
    <ReactFlowProvider>
