...
export interface NuxtIconProps {
  size?: number;
}

/** Nuxt's wordmark, used to identify Nuxt quickstart guides. */
export default function NuxtIcon({size = 20}: NuxtIconProps): JSX.Element {
  return (
