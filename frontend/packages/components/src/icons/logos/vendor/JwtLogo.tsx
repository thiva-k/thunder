...
export interface JwtLogoProps {
  size?: number;
}

/** JWT's geometric icon combined with the "JWT" wordmark. */
export default function JwtLogo({size = 20}: JwtLogoProps): JSX.Element {
  return (
    <svg width={(size * 90) / 32} height={size} viewBox="0 0 90 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
