...
export interface PythonLogoProps {
  size?: number;
}

/** Python's full-color two-snake mark, used to identify Python quickstart guides. */
export default function PythonLogo({size = 64}: PythonLogoProps): JSX.Element {
  return (
    <svg width={size} height={size * 1.018} viewBox="0 0 112 114" fill="none">
      ...
      />
      <defs>
        <linearGradient id="python-gradient-1" x1="0" x2="62.293" y1="0" y2="53.082" gradientUnits="userSpaceOnUse">
