...
export default function ConfigureExport({
  ...
  const applicationsCount =
    resourceCounts?.['application'] ??
    (Array.isArray(configData?.['application']) ? configData['application'].length : 0);
  ...
  const themesCount =
    resourceCounts?.['theme'] ?? (Array.isArray(configData?.['theme']) ? configData['theme'].length : 0);
  ...
  const translationsCount =
    resourceCounts?.['translation'] ??
    (Array.isArray(configData?.['translation']) ? configData['translation'].length : 0);
  const layoutsCount =
    resourceCounts?.['layout'] ?? (Array.isArray(configData?.['layout']) ? configData['layout'].length : 0);
  ...
  const groupsCount =
    resourceCounts?.['group'] ?? (Array.isArray(configData?.['group']) ? configData['group'].length : 0);
  const agentsCount =
    resourceCounts?.['agent'] ?? (Array.isArray(configData?.['agent']) ? configData['agent'].length : 0);
  ...
  if (orgUnitsCount > 0) {
    const orgUnits =
      (configData?.['organization_unit'] as {name?: string; handle?: string; description?: string}[]) ?? [];
