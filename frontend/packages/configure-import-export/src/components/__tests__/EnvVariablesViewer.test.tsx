...
describe('EnvVariablesViewer', () => {
  ...
  describe('rendering', () => {
    ...
    it('hides download button when showDownload is false', () => {
      ...
      expect(screen.queryByText('Download .env')).not.toBeInTheDocument();
    });
  });
  ...
  describe('placeholder detection', () => {
    it('detects placeholder values', () => {
      ...
      expect(
        screen.getByText('Some environment variables contain placeholder values. Edit them below before importing.'),
      ).toBeInTheDocument();
    });
    ...
    it('does not show placeholder warning when no placeholders', () => {
      ...
      expect(
        screen.queryByText('Some environment variables contain placeholder values. Edit them below before importing.'),
  ...
  describe('download functionality', () => {
    it('downloads readonly content when not editable', () => {
      // The real browser running these tests supports the File System Access API; remove it so
      // this test exercises the traditional-download fallback it is asserting on.
      ...
      const downloadButton = screen.getByText('Download .env');
    ...
    it('downloads edited content when editable', () => {
      // See note above: force the traditional-download fallback path.
      delete (window as unknown as {showSaveFilePicker?: unknown}).showSaveFilePicker;
  ...
  describe('edge cases', () => {
    it('handles empty content', () => {
      ...
      expect(screen.getByText('0 variables detected')).toBeInTheDocument();
    });
