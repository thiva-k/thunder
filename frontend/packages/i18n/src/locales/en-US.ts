...
const translations = {
  ...
  applications: {
    ...
    'onboarding.configure.stack.platform.wallet.description':
      'OpenID4VCI wallet that requests verifiable credentials',
  ...
  'verifiable-presentations': {
    ...
    'verify.scanHint': 'Scan the QR code with your wallet or tap the button to open on this device, then approve the request to share your credential.',
    ...
    'form.issuerTrust.description':
      'Control which credential issuers are accepted for this presentation definition.',
    ...
    'create.claims.help':
      'Add each claim once and set whether it is mandatory and restrict its allowed values.',
  ...
  'verifiable-credentials': {
    ...
    'create.steps.claims': 'Claims',
    'create.steps.review': 'Review',
    'create.claims.help': 'Add each claim once and set the attribute name as it appears in the user profile and how it should be displayed in the wallet.',
