...
const translations = {
  ...
  common: {
    ...
    'welcome.sections.learnProduct': 'Learn {{productName}}',
    'welcome.sections.walkthrough': 'Walkthrough',
    'welcome.learnProduct.b2c': 'Consumer App (B2C)',
    'welcome.learnProduct.b2cDesc': 'Try sign-up and login flows for a consumer-facing app',
    'welcome.learnProduct.aiAgents': 'AI Agent Identity',
    'welcome.learnProduct.aiAgentsDesc': 'Try identity patterns for AI agents and tools',
