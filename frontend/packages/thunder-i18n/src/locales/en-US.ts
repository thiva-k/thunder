...
const translations = {
  ...
  applications: {
    ...
    'onboarding.configure.redirectURIs.title': 'Configure',
    'onboarding.configure.redirectURIs.subtitle': 'Add redirect URIs where users will be redirected after authentication',
    'onboarding.configure.redirectURIs.fieldLabel': 'Redirect URIs',
    'onboarding.configure.redirectURIs.placeholder': 'https://localhost:3000/callback',
    'onboarding.configure.redirectURIs.addButton': 'Add',
    'onboarding.configure.redirectURIs.addedLabel': 'Added redirect URIs:',
    'onboarding.configure.redirectURIs.warning': 'At least one redirect URI is required. Please add at least one redirect URI.',
    'onboarding.configure.redirectURIs.hint': 'Redirect URIs must be valid URLs (http:// or https://). These are the allowed callback URLs for your application after authentication.',
    'onboarding.configure.redirectURIs.errors.empty': 'Please enter a redirect URI',
    'onboarding.configure.redirectURIs.errors.invalid': 'Please enter a valid URL (must start with http:// or https://)',
    'onboarding.configure.redirectURIs.errors.duplicate': 'This redirect URI has already been added',
