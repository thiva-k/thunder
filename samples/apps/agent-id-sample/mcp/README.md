...
Streamable-HTTP MCP server that wraps the Wayfinder Travel REST API and forwards the incoming `Authorization` header unchanged. No configuration required for local dev.
