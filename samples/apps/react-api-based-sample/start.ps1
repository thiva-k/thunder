...
Write-Host "[INFO] Starting React API-based Sample App Server on port $SERVER_PORT..."
Write-Host ""
...
Write-Host ""
Write-Host "[INFO] React API-based Sample App running at ${protocol}://localhost:$SERVER_PORT"
