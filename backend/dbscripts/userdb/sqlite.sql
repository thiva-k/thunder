...
CREATE INDEX idx_entity_category_deployment ON ENTITY (DEPLOYMENT_ID, ENTITY_CATEGORY);
...
CREATE TABLE ENTITY_IDENTIFIER (
    ...
    CREATED_AT      TEXT DEFAULT (datetime('now')),
    PRIMARY KEY (ENTITY_ID, DEPLOYMENT_ID, TYPE),
...
CREATE INDEX idx_entity_identifier_lookup ON ENTITY_IDENTIFIER (TYPE, VALUE);
