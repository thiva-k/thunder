...
func (_c *groupStoreInterfaceMock_GetGroup_Call) Return(groupDAO GroupDAO, err error) *groupStoreInterfaceMock_GetGroup_Call {
...
func (_c *groupStoreInterfaceMock_GetGroupList_Call) Return(groupBasicDAOs []GroupBasicDAO, err error) *groupStoreInterfaceMock_GetGroupList_Call {
...
func (_c *groupStoreInterfaceMock_GetGroupMembers_Call) Return(members []Member, err error) *groupStoreInterfaceMock_GetGroupMembers_Call {
...
func (_mock *groupStoreInterfaceMock) GetGroupsByOrganizationUnit(ctx context.Context, oUID string, limit int, offset int) ([]GroupBasicDAO, error) {
...
func (_c *groupStoreInterfaceMock_GetGroupsByOrganizationUnit_Call) Return(groupBasicDAOs []GroupBasicDAO, err error) *groupStoreInterfaceMock_GetGroupsByOrganizationUnit_Call {
	_c.Call.Return(groupBasicDAOs, err)
	return _c
}

func (_c *groupStoreInterfaceMock_GetGroupsByOrganizationUnit_Call) RunAndReturn(run func(ctx context.Context, oUID string, limit int, offset int) ([]GroupBasicDAO, error)) *groupStoreInterfaceMock_GetGroupsByOrganizationUnit_Call {
	_c.Call.Return(run)
	return _c
}
