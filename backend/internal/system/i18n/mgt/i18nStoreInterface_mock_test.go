...
func (_c *i18nStoreInterfaceMock_GetTranslations_Call) Return(stringToStringToTranslation map[string]map[string]Translation, err error) *i18nStoreInterfaceMock_GetTranslations_Call {
