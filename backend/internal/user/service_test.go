...
func TestUserService_GetUserGroups(t *testing.T) {
	...
	mockStore.On("GetGroupCountForEntity", mock.Anything, userID, entitypkg.EntityCategoryUser).Return(5, nil)
	mockStore.On("GetEntityGroups", mock.Anything, userID, entitypkg.EntityCategoryUser, limit, offset).
...
func TestUserService_GetUserGroups_ErrorCases(t *testing.T) {
	...
	t.Run("StoreErrorOnCount", func(t *testing.T) {
		...
		mockStore.On("GetGroupCountForEntity", mock.Anything, "u1", entitypkg.EntityCategoryUser).
