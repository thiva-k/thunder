...
func (_mock *sessionDataStoreInterfaceMock) AddSession(value SessionData) string {
	...
	var r0 string
	if returnFunc, ok := ret.Get(0).(func(SessionData) string); ok {
		r0 = returnFunc(value)
	} else {
		r0 = ret.Get(0).(string)
	}
...
func (_c *sessionDataStoreInterfaceMock_AddSession_Call) Run(run func(value SessionData)) *sessionDataStoreInterfaceMock_AddSession_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 SessionData
		if args[0] != nil {
			arg0 = args[0].(SessionData)
		}
		run(
			arg0,
		)
...
func (_c *sessionDataStoreInterfaceMock_AddSession_Call) RunAndReturn(run func(value SessionData) string) *sessionDataStoreInterfaceMock_AddSession_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *sessionDataStoreInterfaceMock) GetSession(key string) (bool, SessionData) {
	...
	var r0 bool
	var r1 SessionData
	if returnFunc, ok := ret.Get(0).(func(string) (bool, SessionData)); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(string) SessionData); ok {
		r1 = returnFunc(key)
	} else {
...
func (_c *sessionDataStoreInterfaceMock_GetSession_Call) Return(b bool, sessionData SessionData) *sessionDataStoreInterfaceMock_GetSession_Call {
	_c.Call.Return(b, sessionData)
	return _c
}

func (_c *sessionDataStoreInterfaceMock_GetSession_Call) RunAndReturn(run func(key string) (bool, SessionData)) *sessionDataStoreInterfaceMock_GetSession_Call {
	_c.Call.Return(run)
	return _c
}
