...
var queryInsertJTI = dbmodel.DBQuery{
	ID: "JTQ-JRS-01",
	Query: `INSERT OR IGNORE INTO "JTI_RECORD" (NAMESPACE, JTI, EXPIRY_TIME, DEPLOYMENT_ID) ` +
		`VALUES ($1, $2, $3, $4)`,
	PostgresQuery: `INSERT INTO "JTI_RECORD" (NAMESPACE, JTI, EXPIRY_TIME, DEPLOYMENT_ID) ` +
