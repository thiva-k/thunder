...
func Initialize(
	...
	userInfoService := newUserInfoService(jwtService, userService, applicationService)
...
func registerRoutes(mux *http.ServeMux, userInfoHandler *userInfoHandler) {
	...
	mux.HandleFunc(middleware.WithCORS("GET /oauth2/userinfo",
		userInfoHandler.HandleUserInfo, opts))

	mux.HandleFunc(middleware.WithCORS("OPTIONS /oauth2/userinfo",
