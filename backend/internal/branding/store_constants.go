...
var (
	...
	queryCreateBranding = dbmodel.DBQuery{
		...
		Query: "INSERT INTO BRANDING (BRANDING_ID, DISPLAY_NAME, PREFERENCES) VALUES ($1, $2, $3)",
	}

	// queryGetBrandingByID retrieves a branding configuration by ID.
	queryGetBrandingByID = dbmodel.DBQuery{
		ID:    "BRQ-BRANDING_MGT-02",
		Query: "SELECT BRANDING_ID, DISPLAY_NAME, PREFERENCES FROM BRANDING WHERE BRANDING_ID = $1",
	}
	...
	queryGetBrandingList = dbmodel.DBQuery{
		...
		Query: "SELECT BRANDING_ID, DISPLAY_NAME FROM BRANDING ORDER BY CREATED_AT DESC LIMIT $1 OFFSET $2",
	}
	...
	queryGetBrandingListCount = dbmodel.DBQuery{
		...
		Query: "SELECT COUNT(*) as total FROM BRANDING",
	}
	...
	queryUpdateBranding = dbmodel.DBQuery{
		...
		PostgresQuery: "UPDATE BRANDING SET DISPLAY_NAME = $1, PREFERENCES = $2, " +
			"UPDATED_AT = NOW() WHERE BRANDING_ID = $3",
		SQLiteQuery: "UPDATE BRANDING SET DISPLAY_NAME = $1, PREFERENCES = $2, " +
			"UPDATED_AT = datetime('now') WHERE BRANDING_ID = $3",
	...
	queryDeleteBranding = dbmodel.DBQuery{
		...
		Query: "DELETE FROM BRANDING WHERE BRANDING_ID = $1",
	}
	...
	queryCheckBrandingExists = dbmodel.DBQuery{
		...
		Query: "SELECT COUNT(*) as count FROM BRANDING WHERE BRANDING_ID = $1",
	}
	...
	queryGetApplicationsCountByBrandingID = dbmodel.DBQuery{
		...
		Query: "SELECT COUNT(*) as count FROM SP_APP WHERE BRANDING_ID = $1",
	}
)
