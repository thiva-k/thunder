...
// EntityProviderInterface defines the gateway → directory boundary contract for entity operations.
// Gateway-layer consumers (application service, role service, flow executors) use this interface
// to interact with the directory-layer entity service.
