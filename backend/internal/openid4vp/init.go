...
func Initialize(
	...
	ouResolver definition.OUResolver,
) (
	...
	defSvc, defExporter, err := definition.Initialize(mux, ouResolver)
	if err != nil {
		return nil, nil, nil, err
	}
	...
	}, newDBStateStore(configCrypto), cfg.ClientID, signer, trust, defSvc)
	if err != nil {
		return nil, nil, nil, err
	}
