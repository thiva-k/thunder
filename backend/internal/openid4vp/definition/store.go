...
type definitionStoreInterface interface {
	Create(ctx context.Context, dto PresentationDefinitionDTO) error
	GetByID(ctx context.Context, id string) (*PresentationDefinitionDTO, error)
	GetByHandle(ctx context.Context, handle string) (*PresentationDefinitionDTO, error)
	List(ctx context.Context) ([]PresentationDefinitionDTO, error)
	ListSummaries(ctx context.Context) ([]PresentationDefinitionSummary, error)
	Update(ctx context.Context, dto PresentationDefinitionDTO) error
...
func (s *definitionStore) Create(ctx context.Context, dto PresentationDefinitionDTO) error {
...
func (s *definitionStore) GetByID(ctx context.Context, id string) (*PresentationDefinitionDTO, error) {
	return s.getOne(ctx, queryGetDefinitionByID, id)
}

func (s *definitionStore) GetByHandle(ctx context.Context, handle string) (*PresentationDefinitionDTO, error) {
...
func (s *definitionStore) List(ctx context.Context) ([]PresentationDefinitionDTO, error) {
	dbClient, err := s.dbProvider.GetConfigDBClient()
	if err != nil {
		return nil, fmt.Errorf("failed to get database client: %w", err)
	}
...
func (s *definitionStore) ListSummaries(ctx context.Context) ([]PresentationDefinitionSummary, error) {
	dbClient, err := s.dbProvider.GetConfigDBClient()
	if err != nil {
		return nil, fmt.Errorf("failed to get database client: %w", err)
	}
	...
	summaries := make([]PresentationDefinitionSummary, 0, len(results))
	for _, row := range results {
		summaries = append(summaries, PresentationDefinitionSummary{
...
func (s *definitionStore) Update(ctx context.Context, dto PresentationDefinitionDTO) error {
	dbClient, err := s.dbProvider.GetConfigDBClient()
	if err != nil {
		return fmt.Errorf("failed to get database client: %w", err)
	}
...
func (s *definitionStore) Delete(ctx context.Context, id string) error {
	dbClient, err := s.dbProvider.GetConfigDBClient()
	if err != nil {
		return fmt.Errorf("failed to get database client: %w", err)
	}
...
func (s *definitionStore) IsDeclarative(_ context.Context, _ string) (bool, error) {
	return false, nil
}
