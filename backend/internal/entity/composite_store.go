...
func (c *entityCompositeStore) GetGroupCountForEntity(
	ctx context.Context, entityID string, category string) (int, error) {
	return c.dbStore.GetGroupCountForEntity(ctx, entityID, category)
}
...
func (c *entityCompositeStore) GetEntityGroups(ctx context.Context, entityID string,
	category string, limit, offset int) ([]EntityGroup, error) {
	return c.dbStore.GetEntityGroups(ctx, entityID, category, limit, offset)
}
