...
var (
	...
	ErrorMissingRoleID = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1002",
		Error: tidcommon.I18nMessage{
	...
	ErrorRoleNotFound = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1003",
		Error: tidcommon.I18nMessage{
	...
	ErrorRoleNameConflict = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1004",
		Error: tidcommon.I18nMessage{
	...
	ErrorInvalidAssignmentID = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1007",
		Error: tidcommon.I18nMessage{
	...
	ErrorEmptyAssignments = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1010",
		Error: tidcommon.I18nMessage{
	...
	ErrorMissingEntityOrGroups = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1011",
		Error: tidcommon.I18nMessage{
	...
	ErrorInvalidPermissions = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1012",
		Error: tidcommon.I18nMessage{
	...
	ErrorImmutableRole = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1013",
		Error: tidcommon.I18nMessage{
	...
	ErrorDeclarativeModeCreateNotAllowed = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1015",
		Error: tidcommon.I18nMessage{
	...
	ErrorRoleIDConflict = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1018",
		Error: tidcommon.I18nMessage{
	...
	ResultLimitExceededInCompositeMode = tidcommon.ServiceError{
		Type: tidcommon.ClientErrorType,
		Code: "ROL-1017",
		Error: tidcommon.I18nMessage{
