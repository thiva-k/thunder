...
* ❌ Unclear ideas or feature requests → Use [problem definition guide](1-problem-definition.md)
...
* Implement it yourself (move to [Development Guide](3-development.md))  
