...
<NextSteps>
  ...
  />
  <NextStepsCard
    title="Who May Call the Agent"
    description="The posture you did not build here: decide which users, applications, and agents may reach your agent at all."
    href="../../../use-cases/ai-agents/solve-agent-as-resource"
  />
  <NextStepsCard
    title="Act for a Person"
    description="How an agent acts on a customer's behalf, with a token that names the customer as the subject and the agent as the actor."
    href="../../../use-cases/ai-agents/solve-acts-for-user"
  />
  <NextStepsCard
