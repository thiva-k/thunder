...
1. On the **Advanced** tab, set **Operating Mode** to **On behalf of a user**. This extends the agent to also sign users in, enabling the `authorization_code` grant the on-behalf-of flow needs.
