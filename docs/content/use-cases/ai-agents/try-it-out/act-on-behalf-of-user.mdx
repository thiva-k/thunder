...
:::info Background
[Connect to Services → The agent acts on behalf of a user](../../connect-to-services#the-agent-acts-on-behalf-of-a-user) covers the requirements story behind this use case.
:::
