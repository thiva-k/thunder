...
- Sign-in via enterprise identity providers (OIDC) for prosumer or mixed audiences.
...
Once you know which use cases apply, the next decision is how to integrate. See **[Solution Patterns](../solution-patterns)** to compare different approaches and choose what fits your application.
