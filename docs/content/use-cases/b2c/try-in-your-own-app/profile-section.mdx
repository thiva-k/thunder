...
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| React       | [React SDK Overview](../../../../sdks/react/overview), [`<UserProfile />`](../../../../sdks/react/apis/components/user-profile) for the full profile UI, [`<User />`](../../../../sdks/react/apis/components/user) to read user attributes                               |
| Next.js     | [Next.js Quickstart](../../../../getting-started/connect-your-application/nextjs)                                                                     |
| Vue         | [Vue Quickstart](../../../../getting-started/connect-your-application/vue)                                                                            |
