...
The four approaches differ on UI rendering and journey control. Choose the one that fits your application's UX requirements first, then review the supporting patterns in Part B.
