...
description: How the Wayfinder sample maps to product concepts such as user types, resource servers, permissions, roles, applications, and flows.
sidebar_position: 5
---

# Identity Concepts

This page explains the identity concepts behind the Wayfinder sample you set up in [Try It Out](../try-it-out). Each section describes one <ProductName /> concept and shows how the sample uses it.
