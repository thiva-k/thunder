...
In this walkthrough, John Doe adds his **Wayfinder Sky Pass** to his mobile wallet. Wayfinder acts as the **issuer**: it shows John a credential offer, his wallet runs the OpenID4VCI flow against <ProductName />, John signs in to authorize, and the pass — carrying his tier, name, and member ID as selectively-disclosable claims — lands in the wallet.
...
3. Open your wallet (**Heidi** or **Lissi**) and scan the QR. The wallet reads the credential offer from <ProductName /> and starts the issuance flow.
