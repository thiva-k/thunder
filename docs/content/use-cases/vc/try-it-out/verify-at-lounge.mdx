...
2. Open your wallet and scan it. The wallet fetches the signed presentation request from <ProductName /> and shows what the lounge is asking for: your **tier**, and optionally your **name**.
