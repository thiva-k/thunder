...
description: Guard routes in TanStack Router applications with authentication
---
...
The TanStack Router `ProtectedRoute` does not include `onSignIn` or `signInOptions` props. For custom sign-in logic, use the [`useThunderID()`](/docs/next/sdks/react/apis/hooks/use-thunderid) hook directly in the protected component or layout.
