...
description: V1 function for app-native registration flows
---
...
:::note
For new integrations, prefer [`executeEmbeddedSignUpFlowV2`](/docs/next/sdks/javascript/apis/flows/embedded-sign-up-flow-v2).
:::
