...
description: Low-level V1 functions for app-native authentication flows
---
...
:::note
For new integrations, prefer the [V2 flow functions](/docs/next/sdks/javascript/apis/flows/embedded-sign-in-flow-v2), which offer a richer response model and better error handling.
:::
