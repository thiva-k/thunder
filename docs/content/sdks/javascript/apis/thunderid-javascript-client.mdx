...
description: Base authentication client class for building platform adapters
---
...
|-----------|------|-------------|
| `config` | `AuthClientConfig` | Application configuration. See [Configuration Reference](/docs/next/sdks/javascript/apis/configuration) |
