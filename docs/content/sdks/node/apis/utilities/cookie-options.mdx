---
title: CookieOptions
description: Interface for session cookie configuration options
---

# `CookieOptions`

`CookieOptions` defines the shape of cookie configuration options used in the <ProductName /> Node.js SDK. Pass a `CookieOptions` object to [`getSessionCookieOptions`](/docs/next/sdks/node/apis/utilities/get-session-cookie-options) to override the default cookie settings.
...
- [`CookieConfig`](/docs/next/sdks/node/apis/utilities/cookie-config) — Default values for cookie properties
- [`getSessionCookieOptions()`](/docs/next/sdks/node/apis/utilities/get-session-cookie-options) — Merges provided options with defaults
