...
- Complete the [Handling Authentication](/docs/next/sdks/node/guides/handling-authentication) guide to set up the client and session management.
...
- [Protecting Routes](/docs/next/sdks/node/guides/protecting-routes) — Restrict access to routes based on authentication state
- [`ThunderIDNodeClient`](/docs/next/sdks/node/apis/clients/thunderid-node-client) — Base client class reference
