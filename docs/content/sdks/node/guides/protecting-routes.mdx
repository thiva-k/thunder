...
- Complete the [Handling Authentication](/docs/next/sdks/node/guides/handling-authentication) guide to set up the authentication client and session cookie.
...
- [Accessing Protected APIs](/docs/next/sdks/node/guides/accessing-protected-apis) — Use the access token to call downstream services
