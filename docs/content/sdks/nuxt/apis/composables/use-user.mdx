---
title: useUser()
description: Access the authenticated user object
---
...
- Use [`useThunderID()`](/docs/next/sdks/nuxt/apis/composables/use-thunderid) if you also need access to auth methods (`signIn`, `signOut`, etc.).
