...
description: Read the typed ThunderID context attached to an H3 event
---
...
- For routes where the plugin may not have run, fall back to [`useServerSession()`](/docs/next/sdks/nuxt/apis/server/use-server-session).
