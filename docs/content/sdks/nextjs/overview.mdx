...
description: Next.js SDK for server-side authentication integration
---
...
To get started quickly, check out our [Next.js Quickstart Guide](/docs/next/guides/getting-started/connect-your-application/nextjs) for step-by-step instructions.
...
- **[`<ThunderIDProvider />`](/docs/next/sdks/nextjs/apis/thunderid-provider)** — Server-side provider that wraps your app layout
- **[Server Actions](/docs/next/sdks/nextjs/apis/server-actions)** — Authentication, session, and user management actions
- **[`thunderid()`](/docs/next/sdks/nextjs/apis/server-actions#thunderid-client-access)** — Direct access to the server-side client for token and session operations

### Middleware (`@thunderid/nextjs/middleware`)

- **[`thunderIDMiddleware()`](/docs/next/sdks/nextjs/apis/middleware)** — Automatic token refresh and route protection
- **[`createRouteMatcher()`](/docs/next/sdks/nextjs/apis/middleware#createroutematcher)** — Define protected route patterns
