...
sidebar_position: 3
persona: app
description: Quick start guide to integrate with an Express application
---
...
Before integrating <ProductName /> with your Express app, you need to create an application in <ProductName />.
...
Replace `<your-client-id>` and `<your-client-secret>` with values from your <ProductName /> application.
:::
