...
sidebar_position: 3
persona: app
description: Quick start guide to integrate with a Nuxt 3 application
---
...
This is **step 4** of the getting started sequence. By the end you will have a working Nuxt 3 app with sign-in and sign-out powered by <ProductName />.
...
Before integrating <ProductName /> with your Nuxt app, you need to create an application in <ProductName />.
