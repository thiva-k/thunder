...
:::tip Success
You should see the sign-in button. Click it to open the <ProductName />-hosted sign-in page. Authenticate with the test user you created in step 2, and land back in your app with the user profile displayed.
:::
