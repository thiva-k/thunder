...
:::tip Success
You should see the sign-in button. Click it, you'll be redirected to the <ProductName />-hosted sign-in page. Authenticate with the test user you created in step 2 and you'll land back in your app with the user profile displayed.
:::
