...
sidebar_position: 3
description: RFC 9449 Demonstrating Proof-of-Possession in {{ProductName}} — bind access and refresh tokens to a client-held key so stolen tokens are useless without the key.
---
