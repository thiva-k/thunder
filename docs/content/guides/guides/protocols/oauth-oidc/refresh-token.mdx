...
title: Refresh Token
sidebar_position: 3
description: The OAuth 2.1 Refresh Token grant in {{ProductName}} — exchange a refresh token for a new access token, with optional rotation and audience preservation.
---
