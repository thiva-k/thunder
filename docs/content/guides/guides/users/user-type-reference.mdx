...
<ProductName /> includes two default user types with pre-defined schemas. You can use these as-is,  customize them or create your own user types. See [User Types](../user-types) for more information.
