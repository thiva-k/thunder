...
<ProductName /> ships with two default user types. Learn more about the schemas of these default user types in [User Type Reference](../user-type-reference).

| User Type | Description | Organization Unit | Self-Registration |
|-----------|-------------|-------------------|-------------------|
| **Customer** | End users who interact with your application, such as consumers or subscribers. | Customers | Allowed |
