---
id: resource-server-management-api
title: "Resource Server Management API"
description: "This API is used to manage resource servers, resources, and actions for permission-based access control."
...
<Heading
  ...
  children={"Resource Server Management API"}
>
</Heading>
