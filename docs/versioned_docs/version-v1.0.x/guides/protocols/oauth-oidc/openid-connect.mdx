...
3. Optionally configure ID Token format, encryption, and lifetime on the same tab (see [Token Formats](../token-formats)). Signing uses the deployment signing key.
4. Save.
