...
docType: community
description: Learn about Advanced Topics and how to apply it in configuration, integration, and operational workflows.
---
...
themeConfig: {
  ...
  footer: {
    ...
    copyright: `Copyright © ${new Date().getFullYear()} The ThunderID Authors`,
  },
