...
PKCE (RFC 7636) is a security extension for OAuth 2.0 that enhances the security of the Authorization Code flow, especially for public clients.
...
- **Best Practice**: Recommended for all authorization code flows
...
- [Authorization Code Flow](../grant-types/authorization-code.md) - Using PKCE with authorization code flow
