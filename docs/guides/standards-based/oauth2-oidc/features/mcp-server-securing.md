...
## Alternative: Client Credentials Flow (M2M)

For machine-to-machine scenarios without user interaction, use the Client Credentials flow:
...
- [Authorization Code Flow](../grant-types/authorization-code.md) - Detailed authorization code flow guide
- [Client Credentials Flow](../grant-types/client-credentials.md) - M2M authentication
