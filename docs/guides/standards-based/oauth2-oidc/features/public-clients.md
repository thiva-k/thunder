...
- **PKCE is enforced** - Public clients cannot authorize without PKCE at runtime, adhering to OAuth 2.1, regardless of the `pkce_required` setting.
...
- [Authorization Code Flow](../grant-types/authorization-code.md) - Using with public clients
