...
3. Permission evaluation:
   - Custom scopes are passed to the authentication flow as `requested_permissions`
...
- [Authorization Code Flow](../grant-types/authorization-code.md) - How to request scopes
