...
The Authorization endpoint (`/oauth2/authorize`) initiates the OAuth 2.0 authorization flow.
...
- [Authorization Code Flow](../grant-types/authorization-code.md) - Complete flow guide
