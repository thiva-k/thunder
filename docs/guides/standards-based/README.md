...
Thunder implements industry-standard OAuth 2.1 and OpenID Connect (OIDC) protocols for secure authentication and authorization. This section provides comprehensive documentation for all standards-based flows and features.

## 📚 Contents

### [OAuth 2.1 & OpenID Connect (OIDC)](oauth2-oidc/)

OAuth 2.1 is an authorization framework that enables applications to obtain limited access to resources. OpenID Connect (OIDC) is an authentication layer built on top of OAuth that enables clients to verify the identity of users.

**Supported Grant Types:**
- [Authorization Code Flow](oauth2-oidc/grant-types/authorization-code.md) - User authorization with token for access delegation
- [Client Credentials Flow](oauth2-oidc/grant-types/client-credentials.md) - Machine-to-machine communication without user interaction
- [Refresh Token Flow](oauth2-oidc/grant-types/refresh-token.md) - Obtain new access tokens without user interaction
- [Token Exchange Flow](oauth2-oidc/grant-types/token-exchange.md) - Exchange tokens for different use cases

**Endpoints:**
- [Authorization Endpoint](oauth2-oidc/endpoints/authorization-endpoint.md) - `/oauth2/authorize` - Initiate authorization flow
...
> 
> Learn how to secure Model Context Protocol (MCP) servers using Thunder's OAuth 2.1 implementation, following the [official MCP Authorization Specification](https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization). This comprehensive guide covers the complete authorization flow including Dynamic Client Registration (DCR), PKCE, and resource parameter usage.
> 
...
1. **[Authorization Code Flow](oauth2-oidc/grant-types/authorization-code.md)** - Most common flow for web applications
2. **[Client Credentials Flow](oauth2-oidc/grant-types/client-credentials.md)** - For machine-to-machine communication
